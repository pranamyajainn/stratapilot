        ...
        <div className="space-y-3 relative">
            ...
            return (
                ...
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center border transition-all duration-500 flex-shrink-0 ${
                    isActive ? 'bg-indigo-600 border-indigo-500 shadow-lg shadow-indigo-500/30' : 
              ...
              {techLayers.map((layer, idx) => {
                  ...
                  return (
                      <div key={idx} className={`flex items-start gap-4 relative z-10 transition-all duration-500 ${isActive ? 'translate-x-2' : ''}`}>
                          <div className={`w-12 h-12 rounded-full flex items-center justify-center border-4 transition-all duration-500 flex-shrink-0 ${
                              isActive ? 'bg-white border-indigo-500 shadow-xl shadow-indigo-100 scale-110' : 
